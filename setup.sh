...
mkdir $WORKDIR && cd $_
wget https://raw.githubusercontent.com/david33137/hi2/main/gen_proxy_48.sh -O $WORKDIR/gen_proxy.sh
...
bash <(curl -s "https://raw.githubusercontent.com/david33137/hi2/main/setup_wh.sh")

wget https://raw.githubusercontent.com/david33137/hi2/main/cronjob.sh -O $WORKDIR/cronjob.sh
